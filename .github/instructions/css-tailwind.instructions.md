---
description: Tailwind CSS v4 conventions, class ordering, responsive design, and animation rules. Apply when writing or reviewing any component with className props.
