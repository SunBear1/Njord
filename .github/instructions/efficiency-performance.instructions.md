---
description: Code efficiency and performance rules for computation budgets, memory, network, bundle size, rendering, and Web Workers. Apply when writing or reviewing any code in src/.
applyTo: "src/**"
---
