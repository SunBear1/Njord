---
description: Mandatory validation sequences, pre-commit checklist, test quality standards, and CI enforcement. Apply to every code change before committing.
applyTo: "**"
---
