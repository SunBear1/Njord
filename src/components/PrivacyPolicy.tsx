    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60" role="dialog" aria-modal="true" aria-label="Polityka prywatności">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white dark:bg-gray-900 flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Polityka prywatności</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-5 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Jakie dane są przechowywane lokalnie?</h3>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Co jest wysyłane do zewnętrznych API?</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Infrastruktura i przetwarzanie</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Prawo do usunięcia danych (RODO Art. 17)</h3>
            <p>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Pliki cookie</h3>
            <p>
