  ...
  return (
    <div className="space-y-3">
      <div className="space-y-1">
        <label htmlFor="etf-ticker" className="text-sm font-medium text-body dark:text-on-dark-muted flex items-center gap-1.5">
          Ticker ETF
        ...
        >
          <input
            ...
            className="flex-1 border border-edge-strong rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-surface-dark/30 dark:bg-surface-dark-alt dark:border-edge-strong dark:text-on-dark dark:placeholder-gray-400"
          />
          <button
            type="submit"
            disabled={etfLoading || !localEtfTicker.trim()}
            className="flex items-center gap-1.5 px-3 py-2 text-sm bg-accent text-on-dark rounded-lg hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      ...
      <div className="space-y-1">
        <label htmlFor="etf-return" className="text-sm font-medium text-body dark:text-on-dark-muted flex items-center gap-1.5">
      ...
      <div className="space-y-1">
        <label htmlFor="etf-ter" className="text-sm font-medium text-body dark:text-on-dark-muted flex items-center gap-1.5">
