          ...
          <div className="bg-bg-card rounded-xl border border-border shadow-sm p-5 space-y-3">
            ...
            <ResponsiveContainer width="100%" height={400} debounce={32}>
              <AreaChart data={fanChartBands} margin={{ top: 10, right: 10, bottom: 24, left: 10 }}>
                ...
                {/* p25–p50 band */}
                <Area type="monotone" dataKey="band_p25_p50" stackId="fan" stroke="none" fill={isDark ? '#38bdf8' : '#0369a1'} fillOpacity={0.3} name="band_p25_p50" />
                {/* p50–p75 band */}
                <Area type="monotone" dataKey="band_p50_p75" stackId="fan" stroke="none" fill={isDark ? '#38bdf8' : '#0369a1'} fillOpacity={0.3} name="band_p50_p75" />
                ...
                <Area type="monotone" dataKey="p50" stroke={isDark ? '#38bdf8' : '#0369a1'} strokeWidth={2} fill="none" name="Mediana" />
                {/* Reference lines */}
                ...
                <ReferenceLine y={analysis.optimalTarget.target} stroke={isDark ? '#38bdf8' : '#0369a1'} strokeDasharray="6 3" strokeWidth={2} label={{ value: `Cel: ${fmtUSD(analysis.optimalTarget.target)}`, position: 'right', fontSize: 10, fill: isDark ? '#38bdf8' : '#0369a1' }} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-bg-card rounded-xl border border-border shadow-sm p-5 space-y-3">
            ...
            <ResponsiveContainer width="100%" height={300} debounce={32}>
              <LineChart data={touchCurveData} margin={{ top: 10, right: 10, bottom: 24, left: 10 }}>
                ...
                />
                <Line type="monotone" dataKey="pTouch" stroke={isDark ? '#38bdf8' : '#0369a1'} strokeWidth={2.5} dot={{ r: 3 }} name="P(touch)" />
