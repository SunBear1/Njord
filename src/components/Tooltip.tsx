  ...
  return (
    ...
    >
      {children ?? (
        <Info
          size={12}
          className="text-text-faint cursor-help hover:text-gray-600 dark:hover:text-text-secondary transition-colors"
          aria-hidden="true"
        />
      )}
      {visible && createPortal(
        <span
          ...
          className={[
            ...
            width,
            'rounded-lg bg-gray-800 dark:bg-bg-secondary text-white text-xs px-2.5 py-2',
