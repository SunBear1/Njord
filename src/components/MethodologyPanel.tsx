...
export function MethodologyPanel() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
      ...
      {open && (
        <div className="px-5 py-4 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-800 dark:text-gray-100 space-y-5">

          {/* 1. Wartość bieżąca */}
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">1. Wartość bieżąca portfela</h3>
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 font-mono text-xs">
          ...
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">2a. Konto oszczędnościowe</h3>
          ...
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">2b. Obligacje skarbowe</h3>
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 font-mono text-xs space-y-1">
          ...
          {/* 3. Trzymanie akcji */}
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">3. Trzymanie akcji (scenariusz)</h3>
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 font-mono text-xs space-y-1">
          ...
          {/* 5. Oś czasu */}
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">5. Wykres wartości w czasie</h3>
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 font-mono text-xs space-y-1">
          ...
          {/* 6. Heatmapa */}
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">6. Mapa break-even</h3>
            <p className="text-xs text-gray-600 dark:text-gray-400">
          ...
          <section className="space-y-1">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">7. Korekta o inflację (zwrot realny)</h3>
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 font-mono text-xs">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              ...
              <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded text-[11px]">rate(t) = 2,5% + (r₀ − 2,5%) × e<sup>−t/18</sup></code>{' '}
