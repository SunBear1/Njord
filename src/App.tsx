...
function App() {
  ...
  const [activeSection, setActiveSection] = useState<AppSection>('investment');
  ...
  return (
    <div className="min-h-screen" style={ROOT_STYLE}>
      <header className="bg-surface-dark text-on-dark shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-5 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-faint truncate">Akcje · Obligacje · Konto oszczędnościowe · Podatek Belki · Kreator portfela</p>
          </div>
          <button
            type="button"
      ...
      <nav className="bg-surface dark:bg-surface-dark border-b border-edge dark:border-edge-strong shadow-sm">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
              activeSection === 'investment'
                ? 'bg-accent dark:bg-accent text-on-dark dark:text-on-dark shadow-sm'
                : 'text-muted dark:text-faint hover:text-body dark:hover:text-on-dark-muted hover:bg-surface-alt dark:hover:bg-surface-dark-alt'
            }`}
          >
      ...
      <main className="flex-1 min-w-0 max-w-7xl mx-auto px-4 py-4 space-y-4">
        {activeSection === 'tax' ? (
          ...
          <>
            ...
            {!canCalc && (
              <div className="bg-surface dark:bg-surface-dark rounded-xl border border-dashed border-edge-strong dark:border-edge-strong p-10 text-center text-faint dark:text-muted space-y-2">
        ...
        {activeSection === 'investment' && currentPriceUSD > 0 && assetData && (
          <div className="flex items-center gap-1 bg-surface-muted dark:bg-surface-dark rounded-lg p-0.5 w-fit">
            <button
        ...
        {activeSection === 'investment' && activeView === 'comparison' && results && (
          <>
            ...
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-surface-alt dark:bg-surface-dark/50 border border-edge dark:border-edge-strong text-xs text-muted dark:text-faint" role="note">
