      ...
      <div className="bg-bg-card rounded-xl border border-border shadow-sm p-5 space-y-4">
        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-accent-primary text-white rounded-lg font-medium text-sm hover:bg-accent-primary-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary"
          >
            {assetLoading ? (
