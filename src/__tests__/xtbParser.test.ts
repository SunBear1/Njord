 ...
 *
 * Tests use real XLSX buffers generated by SheetJS — the exact same binary
 * format the parser receives from File.arrayBuffer() in the browser.
 * No SheetJS mocking: the full parsing pipeline (including date handling,
 * header detection, and float rounding) is exercised end-to-end.
 */
