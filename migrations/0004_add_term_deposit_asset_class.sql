-- Migration 0004: add 'termDeposit' as a valid holdings.asset_class (lokaty)
...
-- rebuilds the table with the widened constraint (same pattern as migration 0003).
...
CREATE TABLE holdings_new (
  ...
  asset_class  TEXT NOT NULL CHECK (asset_class IN ('bond', 'savings', 'stock', 'termDeposit')),
  source       TEXT,
  data         TEXT NOT NULL,
